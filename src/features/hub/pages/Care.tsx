  ...
  return (
    <div className="space-y-6 pb-10 page-enter max-w-3xl mx-auto">
      ...
      <Card variant="elevated" padding="md">
        ...
        <Button variant="secondary" size="sm" onClick={() => { trust.issueCertificate(sid(), getMockUser()?.name ?? 'Student', 'calculus-1', 'Calculus I', 85); setCount(store.certificates.list().length); }}>{t('issueDemo')}</Button>
